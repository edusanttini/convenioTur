                    ...
                    <div>
                        <motion.div
                            ...
                            <p className={`${styles.sectionSubTextGray} text-center pr-32 pl-32 pt-16 pl-sm-4 pr-sm-4 pt-sm-4`}>
                                <span>Ever since it’s founding, Convenio-Tur has specialized not only
                                    in receptive tourism but also in the organization of </span>
                        ...
                        <motion.div
                            ...
                            whileInView="show"
                            viewport={{ once: false, amount: 0.25 }}
                            className={`${styles.innerWidth} mx-auto flex flex-col pt-16`} 
                            >
                            <h2 className={`${styles.sectionHeadSubText} text-center`}
                                style={yellowText}>
                                Incentive Travel
